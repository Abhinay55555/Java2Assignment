...
public class EmpMain {
    ...
    public static void main(String[] args) {
        ...
        Emplll E1 = new Emplll("KH","Honey",25,343400);
        Emplll E2 = new Emplll("Kanna","Honey",22,354020);
        Emplll E3 = new Emplll("Honey","Kanna",22,365700);
        Emplll E4 = new Emplll("KHKH","KannaHoney",20,370800);
        Emplll E5 = new Emplll("Abhinay","Madhire",19,380070);
